...
export function DocumentsStats({
    ...
    return (
        <div className="grid grid-cols-1 gap-4 md:grid-cols-5">
            ...
            <Card>
                <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                    <CardTitle className="text-sm font-medium">Previews Available</CardTitle>
                ...
                <CardContent>
                    ...
                    <p className="text-muted-foreground text-xs">
                        {Math.round((documents.filter(d => d.previewUrl).length / documents.length) * 100) || 0}%
                        coverage
                    </p>
                </CardContent>
            </Card>
            <Card>
                ...
                <CardContent>
                    <div className="text-2xl font-bold">{loading ? "..." : mdCount}</div>
                    <p className="text-muted-foreground text-xs">Static content</p>
                </CardContent>
            </Card>
            <Card>
                <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                ...
                <CardContent>
                    <div className="text-2xl font-bold">{loading ? "..." : mdxCount}</div>
                    <p className="text-muted-foreground text-xs">Interactive content</p>
                </CardContent>
            </Card>
            <Card>
                <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                ...
                <CardContent>
                    ...
                    <p className="text-muted-foreground text-xs">Organization units</p>
                </CardContent>
            </Card>
        </div>
    );
