                    ...
                    <Card className="w-full max-w-2xl">
                        <CardHeader className="text-center">
                            ...
                            <CardDescription className="text-base">
                                An unexpected error has occurred in the application. Don't worry, you can try the
                                following options:
                            </CardDescription>
                        </CardHeader>
                        <CardContent className="space-y-6">
                            ...
                            <div className="text-muted-foreground text-center text-sm">
                                <p>If the problem persists, please reload the page or contact technical support.</p>
                            </div>
                        </CardContent>
                    </Card>
                </div>
